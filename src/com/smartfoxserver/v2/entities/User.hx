...
interface User
{
	 ...
	 * @see		#getPlayerId()
	 */
	@:flash.property var playerId(get,null):Null<Int>;
	 ...
	 * @see 	#isSpectator
	 */
	@:flash.property var isPlayer(get,null):Bool;
	 ...
	 * @see 	#isPlayer
	 */
	@:flash.property var isSpectator(get,null):Bool;
	 ...
	 */
	@:flash.property var isItMe(get,null):Bool;
