...
interface User
{
	 ...
	 * @see		#getPlayerId()
	 */
	@:flash.property var playerId(get,never):Null<Int>;
	 ...
	 * @see 	#isSpectator
	 */
	@:flash.property var isPlayer(get,never):Bool;
	 ...
	 * @see 	#isPlayer
	 */
	@:flash.property var isSpectator(get,never):Bool;
	 ...
	 */
	@:flash.property var privilegeId(get,set):Int;
	 ...
	 */
	@:flash.property var userManager(get,set):IUserManager;
	 ...
	 */
	@:flash.property var isItMe(get,never):Bool;
	 ...
	 */
	@:flash.property var aoiEntryPoint(get,set):Vec3D;
}