...
interface IBuddyManager
{
	 ...
	 */
	var offlineBuddies(get, never):Array<Buddy>;
	 ...
	 * @see		com.smartfoxserver.v2.entities.Buddy#isOnline Buddy.isOnline
	 */
	var  onlineBuddies(get, never):Array<Buddy>;
	 ...
	 * @see #isInited
	 */
	var buddyList(get, never):Array<Buddy>;
	...
	var buddyStates(get, never):Array<String>;
	 ...
	 * @see		#getMyVariable()
	 */
	var myVariables(get, never):Array<BuddyVariable>;
	 ...
	 */
	var myOnlineState(get, never):Bool;
