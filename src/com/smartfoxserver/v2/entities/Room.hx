...
interface Room
{
	 ...
	 */
	@:flash.property var id(get,null):Int;
	 ...
	 */
	@:flash.property var groupId(get,null):String;
	 ...
	 */
	@:flash.property var capacity(get,null):Int;
