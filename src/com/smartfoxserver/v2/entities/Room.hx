...
interface Room
{
	 ...
	 */
	@:flash.property var id(get,never):Int;
	 ...
	 */
	@:flash.property var groupId(get,never):String;
	 ...
	 */
	@:flash.property var isJoined(get,set):Bool;
	 ...
	 */
	@:flash.property var isGame(get,set):Bool;
	 ...
	 * This flag must be set when creating the Room.</p>
	 */
	@:flash.property var isHidden(get,set):Bool;
	 ...
	 */
	@:flash.property var isPasswordProtected(get,set):Bool;

	@:flash.property var isManaged(get, set):Bool;
	 ...
	 */
	@:flash.property var userCount(get,set):Int;
	 ...
	 * This flag must be set when creating the Room.</p>
	 */
	@:flash.property var maxUsers(get,set):Int;
	 ...
	 * This flag depends on the Room state.</p>
	 */
	@:flash.property var spectatorCount(get,set):Int;
	 ...
	 */
	@:flash.property var properties(get,set):Dynamic;
	 ...
	 */
	@:flash.property var roomManager(get, set):IRoomManager;
